...
public:
   ...
   */
  void predict(const rclcpp::Time &stamp, const Eigen::Vector3f &acc,
  ...
  correct(const rclcpp::Time                      &stamp,
...
private:
  ...
  rclcpp::Time
      last_correction_stamp; // when the estimator performed the correction step
